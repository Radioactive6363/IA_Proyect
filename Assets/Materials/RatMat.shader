	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 color1 = IsGammaSpace() ? float4(0.5754717,0.111294,0.111294,0) : float4(0.2906642,0.01186582,0.01186582,0);
...
/*ASEBEGIN
Version=18900
476;251;1060;607;740;100.5;1;True;False
Node;AmplifyShaderEditor.ColorNode;1;-295,-88.5;Inherit;False;Constant;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;0.5754717,0.111294,0.111294,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=9447305A257C1E120DD93DB47E8B117579401630